...
const rick = document.getElementById("Phakhaphon");
...
const phakhaphons = "Phakhaphon Sornnarai";
typeWriter(rick, phakhaphons, 0, 100);
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  socialLinks.forEach(link => {
    link.addEventListener("click", function(event) {
      event.preventDefault();
      const socialMedia = this.querySelector("span").innerText;
      console.log(`You clicked on ${socialMedia}`);
    });
  });
});
